...
//funzione che azzera tutto quando premo il ricomincia
function reset(event){
    ...
    const result=document.querySelector('#result');
    result.classList.add('result_invisible'); //vedi bene
    result.classList.remove('result_visible');

    answers=['0','0','0']; //azzero il vettore
...
let answers=['0','0','0']; //vettore per vedere la risposta per ogni griglia 
